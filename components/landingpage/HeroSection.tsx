...
const messages = [
	{
		...
		avatar: "S",
		bg: "bg-purple-500",
		text: "Hey team! Project update is live 🚀",
		time: "10:42 AM",
		own: false,
	},
	{
		...
		avatar: "A",
		bg: "bg-green-500",
		text: "Awesome! Just reviewed the designs.",
		time: "10:43 AM",
		own: false,
	},
	{
	...
	},
	{
		...
		avatar: "S",
		bg: "bg-purple-500",
		text: "Perfect timing. Let's ship it!",
		time: "10:45 AM",
		own: false,
	},
];
	...
	return (
		<section
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden">
				...
				<div
					className="absolute -bottom-20 -left-20 w-80 h-80 bg-blue-300/15 blob animate-float"
					style={{ animationDelay: "2s" }}
				/>
				<div
					className="absolute top-1/2 left-1/4 w-64 h-64 bg-orange-400/10 blob animate-float-slow"
				...
				{/* Decorative circles */}
				<div
					className="absolute top-20 right-1/4 w-4 h-4 rounded-full bg-orange-400 animate-float"
					style={{ animationDelay: "1s" }}
				/>
				<div
					className="absolute bottom-40 right-16 w-3 h-3 rounded-full bg-white/40 animate-float"
					style={{ animationDelay: "3s" }}
				/>
				<div
					className="absolute top-1/3 left-16 w-5 h-5 rounded-full bg-blue-300/60 animate-float-slow"
					style={{ animationDelay: "0.5s" }}
				/>

				{/* Orange accent shape */}
				<div
					className="absolute top-16 right-12 w-24 h-3 bg-orange-400 rounded-full opacity-70 animate-float"
					style={{ animationDelay: "1.5s" }}
				/>
				<div
					className="absolute bottom-32 left-24 w-16 h-2 bg-white/30 rounded-full animate-float"
				...
				<div className="text-white">
					...
					<h1
						...
						<span className="relative inline-block">
							best chat
							<div
								className="absolute -bottom-1 left-0 right-0 h-1.5 bg-orange-400 rounded-full transform scale-x-0 animate-slide-in-right"
					...
					<p
						...
						The modern team communication platform that brings your whole company together. Fast,
						intuitive, and built for real work.
					</p>
						...
						<div className="flex items-center gap-2">
							<div className="flex -space-x-2">
								{["bg-purple-400", "bg-green-400", "bg-orange-400", "bg-pink-400"].map((c, i) => (
									<div
										key={i}
										className={`w-8 h-8 rounded-full ${c} border-2 border-blue-700 flex items-center justify-center text-white text-xs font-bold`}>
										{["S", "A", "M", "K"][i]}
									</div>
								))}
							</div>
